...
def suggest_outfit(new_item: dict, wardrobe: dict) -> str:
    ...
    if not wardrobe_items:
        prompt = (
            ...
            "They haven't shared their wardrobe yet. Give them 1-2 general outfit "
            "ideas — what types of pieces pair well with this item, what vibe it suits, "
            "and how to style it. Be specific and casual, like a friend who knows fashion."
        )
    else:
        wardrobe_text = "\n".join(
        ...
        prompt = (
            ...
            "pieces from their wardrobe. Name the exact wardrobe pieces. Be specific "
            "about the vibe and how to wear it."
        )
...
def create_fit_card(outfit: str, new_item: dict) -> str:
    ...
    prompt = (
        ...
        "- No hashtags\n"
        "- Do NOT start with 'I'\n\n"
        "Be creative — make it sound like a real person posted this."
    )
